#CSC 4110
#Assignment 7
#Created by Veronica Dean on 3/5/2022
#Work ticket 5
...
#Sorts list
    if menuoption == '4':
        res = sorted(scoreDict.items(), key=lambda x:x[1])
        print("The list after sorting : " + str(res))

#Delete a variable
    if menuoption =='5':
        scoreDict.pop(input("name:  "))
